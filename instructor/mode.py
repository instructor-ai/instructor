...
class Mode(enum.Enum):
    ...
    def tool_modes(cls) -> Set["Mode"]:
        ...
        return {
            cls.FUNCTIONS, cls.PARALLEL_TOOLS, cls.TOOLS, cls.TOOLS_STRICT,
            cls.ANTHROPIC_TOOLS, cls.ANTHROPIC_REASONING_TOOLS, cls.MISTRAL_TOOLS,
            cls.VERTEXAI_TOOLS, cls.VERTEXAI_PARALLEL_TOOLS, cls.GEMINI_TOOLS,
            cls.COHERE_TOOLS, cls.CEREBRAS_TOOLS, cls.FIREWORKS_TOOLS,
            cls.WRITER_TOOLS, cls.BEDROCK_TOOLS
        }
    ...
    def json_modes(cls) -> Set["Mode"]:
        ...
        return {
            cls.JSON, cls.JSON_O1, cls.MD_JSON, cls.JSON_SCHEMA,
            cls.ANTHROPIC_JSON, cls.VERTEXAI_JSON, cls.GEMINI_JSON,
            cls.COHERE_JSON_SCHEMA, cls.CEREBRAS_JSON, cls.FIREWORKS_JSON,
            cls.BEDROCK_JSON, cls.PERPLEXITY_JSON
        }
