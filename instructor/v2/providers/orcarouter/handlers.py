...
# Register OpenAI-compatible handlers (TOOLS, MD_JSON, PARALLEL_TOOLS) for OrcaRouter.
...
@register_mode_handler(Provider.ORCAROUTER, Mode.JSON_SCHEMA)
class OrcaRouterJSONSchemaHandler(OpenAIJSONSchemaHandler):
    """Handler for OrcaRouter structured outputs."""
...
__all__ = ["OrcaRouterJSONSchemaHandler"]
