...
from typing import Callable, Optional, Type, Union, get_args, get_origin, Dict, Tuple, Any, List, Coroutine
...
def wrap_chatcompletion(func: Callable[..., Any], mode: Mode = Mode.FUNCTIONS) -> Callable[..., Any]:
...
def patch(client: Union[OpenAI, AsyncOpenAI], mode: Mode = Mode.FUNCTIONS) -> Union[OpenAI, AsyncOpenAI]:
    """
