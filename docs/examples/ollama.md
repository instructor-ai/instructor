...
!!! note "Learn More"
    ...
    To learn more, please refer to the [docs](../why.md). To understand the benefits of using Pydantic with Instructor, visit the tips and tricks section of the [why use Pydantic](../why.md) page.
