...
class TestImageClass:
    ...
    def test_to_anthropic(self):
        ...
        image = Image(source=self.test_image_path, media_type="image/jpeg", data=self.base64_image)
    ...
    def test_to_openai_base64(self):
        ...
        assert result["type"] == "image_url"
        assert result["image_url"]["url"] == f"data:image/jpeg;base64,{self.base64_image}"
...
class TestImageWithCacheControl:
    ...
    def test_to_anthropic_with_cache_control(self):
        ...
        with patch("instructor.multimodal.Image.to_anthropic") as mock_to_anthropic:
            mock_to_anthropic.return_value = {"type": "image", "source": {"type": "base64", "media_type": "image/jpeg", "data": "test_data"}}
...
class TestConvertContents:
    ...
    def test_convert_image_to_openai(self):
        ...
        image.to_openai.return_value = {"type": "image_url", "image_url": {"url": "test_url"}}
    ...
    def test_convert_image_to_anthropic(self):
        ...
        image = MagicMock(spec=Image)
        image.to_anthropic.return_value = {"type": "image", "source": {"type": "base64"}}
    ...
    def test_convert_audio_to_openai(self):
        ...
        audio.to_openai.return_value = {"type": "input_audio", "input_audio": {"format": "wav"}}
...
class TestConvertMessages:
    ...
    def test_convert_with_autodetect_string(self):
        ...
        with patch("instructor.multimodal.Image.autodetect_safely", return_value="Hello"):
    ...
    def test_convert_with_image_params(self):
        ...
        with patch("instructor.multimodal.ImageWithCacheControl.from_image_params") as mock_from_params:
            mock_image = MagicMock(spec=Image)
            mock_image.to_openai.return_value = {"type": "image_url", "image_url": {"url": "test_url"}}
